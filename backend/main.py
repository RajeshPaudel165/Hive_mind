...
def root() -> dict[str, Any]:
    return {
        ...
        "endpoints": {
            ...
            "agent_permissions": "GET /agents/{agent_id}/permissions",
            "agent_permissions_update": "PUT /agents/{agent_id}/permissions",
            "agent_permissions_reset": "POST /agents/{agent_id}/permissions/reset",
